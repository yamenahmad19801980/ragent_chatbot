"""
Centralized device control service to eliminate duplication.
Handles all device-related operations in one place.
"""
...
class DeviceService:
    ...
    def control_device(self, device_uuid: str, user_message: str, product_type: str) -> Dict[str, Any]:
        ...
        system_prompt = PromptTemplates.format_device_control(
    ...
    def schedule_device(self, device_uuid: str, user_message: str) -> Dict[str, Any]:
        ...
        system_prompt = PromptTemplates.format_device_schedule(
            user_messages=user_messages,
            descriptions=descriptions
        )
    ...
    def trigger_scene_by_name(self, scene_name: str, available_scenes: List[Dict]) -> Dict[str, Any]:
        ...
        system_prompt = PromptTemplates.format_scene_detection(
            user_message=scene_name,
    ...
    def get_scenes(self, project_uuid: str, community_uuid: str, space_uuid: str) -> List[Dict]:
        """Get available scenes for a space."""
